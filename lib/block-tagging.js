...
export function suggestTagsForBlock(blockContent, options = {}) {
  ...
  // 4. TF-IDF keyword extraction (for high-scoring terms not in vocab)
  ...
  // 5. Block type specific suggestions
  if (blockType === 'code') {
